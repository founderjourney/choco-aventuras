...
```bash
git remote add encore encore://atv-rental-system-ufe2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/atv-rental-system-ufe2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/atv-rental-system-ufe2/settings/integrations/github)
