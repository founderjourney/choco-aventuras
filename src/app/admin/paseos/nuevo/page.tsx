...
async function createPaseo(data: any) {
  const response = await fetch('/api/paseos', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
  if (!response.ok) throw new Error('Error creating paseo');
...
export default function NuevoPaseo() {
  ...
  const createMutation = useMutation({
    mutationFn: createPaseo,
    onSuccess: () => {
      toast({
        title: "¡Paseo creado!",
        description: "El paseo ha sido agregado exitosamente.",
      });
    ...
    onError: () => {
      toast({
        title: "Error",
        description: "Hubo un problema al crear el paseo.",
        variant: "destructive",
      });
    }
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createMutation.mutate(paseoData);
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-gray-400">/</span>
          <span className="text-[#1565C0]">Nuevo</span>
        </div>

        {/* Header */}
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#1565C0]">Agregar Paseo</h1>
            <p className="text-gray-600 mt-2">Crea una nueva experiencia para los aventureros</p>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="activo" className="text-sm">
                      Activar paseo (disponible para reservas)
                    </Label>
                  </div>
                  ...
                  <div className="flex gap-4 pt-6">
                    ...
                    >
                      ...
                      {createMutation.isPending ? 'Guardando...' : 'Guardar Paseo'}
                    </Button>
                    <Link href="/admin/paseos">
                      <Button variant="outline" className="flex items-center gap-2">
                        <X className="h-4 w-4" />
